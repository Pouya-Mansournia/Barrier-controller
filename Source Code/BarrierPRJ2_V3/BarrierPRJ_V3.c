...
void TCP(void)
    {
      ...
      if(E == 'X')
      {
       ...
       PINB.7,PINB.6,PINB.5,PINB.4,PINB.3,PINA.5,PINA.4,
       PINA.3,PINA.2,PINA.1,PINA.0,PIND.0,PIND.1,PIND.4,PIND.5,PIND.6,PIND.7,PINF.7,PINF.2,PINF.5,PINF.6);
      }
      else if(E == 'S' )
      {
                RE1=0;
    ...
    void Run()
    {
      LD1=!LD1; delay_ms(100);
      LD2=!LD2; delay_ms(100);
      BUZ=!BUZ; delay_ms(100);
      RE1=!RE1; delay_ms(100);
      RE2=!RE2; delay_ms(100);
      RE3=!RE3; delay_ms(100);
      BUZ=1;
      LD1=0;
      LD2=0;
      delay_ms(80);
...
DDRC=(0<<DDC7) | (1<<DDC6) | (1<<DDC5) | (1<<DDC4) | (1<<DDC3) | (0<<DDC2) | (1<<DDC1) | (1<<DDC0);
// State: Bit7=T Bit6=0 Bit5=0 Bit4=0 Bit3=1 Bit2=T Bit1=0 Bit0=0 
