...
void motorright() // Close
{
    if (RF3==1 || SPB1==1)
    {
            for(timeCounter1=0;timeCounter1<timeLimit1;timeCounter1++)
            {
            Re2=1;
            Re1=1;
            p=read_adc(7);
        ...
        if (RF4==1 || SPB2==1)
        {
           if(DS2==0)
           {
                ...
                delay_ms(3500);
                    ...
                    for (timeCounter2=0;timeCounter2<timeLimit2;timeCounter2++)
                    {
                    Re2=1;
                    Re1=1;
                    p=read_adc(7);
...
void Run()
    {
        LEDS1=!LEDS1; delay_ms(50);
        LEDS2=!LEDS2; delay_ms(50);
        LEDS1=!LEDS1; delay_ms(50);
        LEDS2=!LEDS2; delay_ms(50);
        LEDS1=!LEDS1; delay_ms(50);
        LEDS2=!LEDS2; delay_ms(50);
